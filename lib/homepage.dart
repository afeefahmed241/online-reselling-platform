...
import 'package:flutter_project/categorypage.dart';
...
import 'my_postpage.dart';

class HomePage extends StatelessWidget {
   HomePage({Key? key}) : super(key: key);

  final Stream<QuerySnapshot> subjects = FirebaseFirestore.instance.collection('subjects').snapshots();
      ...
      appBar: AppBar(
        ...
        actions: [
          ...
          IconButton(onPressed:(){
            ...
            Navigator.push(
                context,
                MaterialPageRoute(builder: (context) =>  SearchPage(searchkey: searchController.text.trim())));
